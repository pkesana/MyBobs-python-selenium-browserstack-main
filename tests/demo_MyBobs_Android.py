...
try:
    ...
    time.sleep(5)
    # link_InStoreCart = wait.until(EC.presence_of_element_located((By.XPATH, "//a[normalize-space()='In-Store Carts']")))
    ...
    # driver.find_element(By.XPATH, "/html[1]/body[1]/bobs-app-root[1]/cx-storefront[1]/main[1]/cx-page-layout[1]/cx-page-slot[1]/bobs-checkout-delivery[1]/div[1]/bobs-checkout-delivery-form[1]/bobs-checkout-shipping-form[1]/form[1]/div[1]/div[7]/button[1]").click()
    # time.sleep(5)
    # driver.find_element(By.XPATH,
    #                     "/html[1]/body[1]/bobs-app-root[1]/cx-storefront[1]/main[1]/cx-page-layout[1]/cx-page-slot[1]/bobs-checkout-delivery[1]/div[1]/bobs-checkout-delivery-form[1]/bobs-checkout-shipping-form[1]/form[1]/div[1]/div[7]/button[1]").click()
    time.sleep(15)
    # if button_ContinueToPayment.is_displayed():
    #     button_ContinueToPayment.click()
    #     time.sleep(5)
    # if button_ContinueToPayment.is_displayed():
    #     button_ContinueToPayment.click()
    #     time.sleep(5)
    ...
    # iFrame
    iframeCC = driver.find_element(By.XPATH, """//*[@id="ccframe"]""")
    driver.switch_to.frame(iframeCC)
    time.sleep(5)
    driver.find_element(By.XPATH, "//input[@id='ccNum']").send_keys("4242424242424242")
    time.sleep(2)
    driver.find_element(By.XPATH, "//select[@id='expMnth']").click()
    driver.find_element(By.XPATH, "//select[@id='expMnth']").send_keys('08')
    driver.find_element(By.XPATH, "//select[@id='expYear']").click()
    driver.find_element(By.XPATH, "//select[@id='expYear']").send_keys('2028')
    driver.find_element(By.XPATH, "//input[@id='ccCVV']").send_keys('128')
    driver.switch_to.default_content()
    time.sleep(5)
    driver.find_element(By.XPATH,"//span[@class='bobs-text-large--semibold']").click()
    driver.find_element(By.XPATH, "//button[normalize-space()='Review order']").click() # //button[@class='btn btn-block btn-primary bobs-review-order-button']
    time.sleep(10)


# //input[@class='scaled-input form-check-input ng-untouched ng-pristine ng-valid']
# //button[@type='submit']
