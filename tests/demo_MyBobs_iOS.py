...
try:
    ...
    driver.find_element(By.XPATH, "//a[normalize-space()='Add it now']").click()
    time.sleep(5)
    # driver.find_element(By.XPATH, "//button[normalize-space()='Sign in with Password']").click()
    # driver.find_element(By.XPATH, "//input[@id='password']").send_keys(userPassword)
    # driver.find_element(By.XPATH, "//button[@class='sofa-button-pill-md sofa-btn-red sofa-btn-stretch']").click()
    # time.sleep(5)
    driver.find_element(By.XPATH, "//input[@formcontrolname='giftCardNumber']").send_keys("7107790000085310415")
    driver.find_element(By.XPATH, "(//input[@type='password' and @class='form-control ng-untouched ng-pristine ng-invalid'])").send_keys("36148167")
